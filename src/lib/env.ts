...
const envSchema = z.object({
  ...
  EMBEDDING_DIM: z.coerce
    ...
    .refine((n) => n === EMBEDDING_DIMENSIONS, {
      message: `EMBEDDING_DIM must be ${EMBEDDING_DIMENSIONS} to match the pgvector column (change src/constants/embedding.ts and migrate the DB to use another size)`,
    }),
