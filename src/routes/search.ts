...
import { embeddings, env, storage, vectorDb } from "../services/index.js";
import { assertValidImageUpload } from "../utils/file.js";
import { processImageBytes } from "../utils/image-processing.js";
import { AppError } from "../lib/errors.js";

export const searchRoute = new Hono().post("/image", async (c) => {
  ...
  const matches = await queryNearestByVector(db, vectorDb, vector, topK);
